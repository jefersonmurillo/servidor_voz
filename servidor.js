var servidor=function(puerto,dir){
  //paquete encargado de cargar un archivo del disco duro
  fs=require("fs");
  
  var opciones={
    key:fs.readFileSync("./certificado/privatekey.pem"),
    cert:fs.readFileSync("./certificado/certificate.pem")
  }
  //inicilizar variable https como un servidor
  http = require('https').createServer(opciones,crearServidor);
  ...
  http.listen(puerto,dir,()=>{
    console.log("servidor web ejecutandose  en la direccion ","https://"+dir+":"+puerto);
  });
